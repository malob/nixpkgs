  ...
  options.programs.brew-bundle = {
    ...
    cleanupType = mkOption {
      ...
      description = ''
        ...
        <commnd>brew uninstall --zap</command> is run for all those formulas.
    ...
    masApps = mkOption {
      ...
      description = ''
        ...
        Note that you need to be signed into the Mac App Store for <commnad>mas</command> to
        successfully install and upgrade applications, and that unfortunetely apps removed from this
